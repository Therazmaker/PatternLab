...
function ensureModel(model = null) {
  ...
  return {
    ...
    learnedContexts: base?.learnedContexts && typeof base.learnedContexts === "object" ? base.learnedContexts : {},
    humanOverrideMemory: Array.isArray(base?.humanOverrideMemory) ? base.humanOverrideMemory : [],
    learnedRules: Array.isArray(base?.learnedRules) ? base.learnedRules : [],
